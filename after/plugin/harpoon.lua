...
vim.keymap.set("n", "<leader>hz", function() ui.nav_file(2) end)
vim.keymap.set("n", "<leader>hd", function() ui.nav_file(3) end)
vim.keymap.set("n", "<leader>hv", function() ui.nav_file(4) end)
vim.keymap.set("n", "<leader>hf", function() ui.nav_file(5) end)
vim.keymap.set("n", "<leader>hs", function() ui.nav_file(6) end)
